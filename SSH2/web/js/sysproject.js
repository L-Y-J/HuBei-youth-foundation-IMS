...
function xx_dengji(){
	$("#div2").html("<iframe src='xx_dengji.html' frameborder=\"0\" border=0 width=\"100%\" height=\"500px\"></iframe>")
}

function xx_chaxun(){$("#div2").html("<iframe src='xx_chaxun.html' frameborder=\"0\" border=0 width=\"100%\" height=\"500px\"></iframe>")}
function xx_tongji(){$("#div2").html("<iframe src='xx_tongji.html' frameborder=\"0\" border=0 width=\"100%\" height=\"500px\"></iframe>")}
function xx_shenhe(){$("#div2").html("<iframe src='xx_shenhe.html' frameborder=\"0\" border=0 width=\"100%\" height=\"500px\"></iframe>")}
function xx_chakan(){$("#div2").html("<iframe src='xx_chakan.html' frameborder=\"0\" border=0 width=\"100%\" height=\"500px\"></iframe>")}
